this is a simple project for a clinic management app where the doctors have existing accounts that they can login and the patients can either register or login if they have an existing account.
